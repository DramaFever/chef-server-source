...
process_headers_test() ->
    Headers = [{'ATOM-UPPERCASE', "don't touch me"}, {"STRING-UPPERCASE", "don't touch me"}, {"string-lowercase", "don't touch me"}],
    [{"atom-uppercase", "don't touch me"}, {"string-uppercase", "don't touch me"}, {"string-lowercase", "don't touch me"}]
